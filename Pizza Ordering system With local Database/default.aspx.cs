...
namespace Pizza_Ordering_system_With_local_Database
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        {
            //The button to execute the Start of the order process
            sql_input();
            labels();
        }
        ...
        public void sql_input()
        {
            ...
            try
            {
                ...
                database_cmd = new SqlCommand("insert into pizza_table values('" + customer_order_number + "','" + 0 + "','" + "" + "','" + "" + "')", connect);
        ...
        {
            //clears the current order in the database, allows for the same order number to be used once the page loads again, also clears the labels for use again
            database_cmd = new SqlCommand("delete from pizza_table where Order_number='" + customer_order_number + "'", connect);
            database_cmd.ExecuteNonQuery();
            connect.Close();
